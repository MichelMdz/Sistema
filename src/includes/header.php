...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="blue" data-image="../assets/img/logomedi.jpg">
            ...
            <div class="sidebar-wrapper">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="corte_caja.php">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Sistema Punto de Venta MEDIFAM</a>
                    </div>
